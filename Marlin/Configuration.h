...
#define STRING_CONFIG_H_AUTHOR "(Florian Kogler)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_V1_3	// fkogler
#endif
...
#define CUSTOM_MACHINE_NAME "NotOriginal Prusa I3"	// fkogler
...
#define DEFAULT_bedKp 21.22
#define DEFAULT_bedKi 3.84
#define DEFAULT_bedKd 78.10
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 800, 280 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 4, -0.50 }
...
#define DEFAULT_LEVELING_FADE_HEIGHT 0.0 // (mm) Default fade height 10. //edit from fkogler -> disabled because prints result in 1mm to high
  #endif
